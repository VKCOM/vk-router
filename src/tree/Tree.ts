...
export default class TreeRoutes {
  ...
  private readonly errorLogger = (err: string, arg?: string) => console.error(err, arg);
  ...
  private readonly getByPath = (pathToRoute: string) => {
  ...
  public getRouteNode = (routeName = ''): RouteNode => {
